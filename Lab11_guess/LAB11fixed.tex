...
\begin{figure}[ht]\centering
	...
	\caption{\textit{fast test 1} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast2}
	\caption{\textit{fast test 2} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast3}
	\caption{\textit{fast test 3} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast4}
	\caption{\textit{fast test 4} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 180, width=1\textwidth]{fast5}
	\caption{\textit{fast test 5} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast6}
	\caption{\textit{fast test 6} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast7}
	\caption{\textit{fast test 7} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast8}
	\caption{\textit{fast test 8} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast9}
	\caption{\textit{fast test 9} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}

\begin{figure}[ht]\centering
	\includegraphics[angle = 270, width=1\textwidth]{fast10}
	\caption{\textit{fast test 10} Simulation Waveform}
	\label{fig:sim_with_table}
\end{figure}
